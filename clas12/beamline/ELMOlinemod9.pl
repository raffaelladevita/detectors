...
sub ELMOlinemod9()
{
	...
	$detector{"pos"}         = "0*mm 0*mm $zpos*mm";
	$detector{"dimensions"}  = "0.0*deg 360*deg 6*counts 0.0*mm 0.0*mm 0.0*mm 0.0*mm 0.0*mm 0.0*mm 34.925*mm 34.925*mm 54.0*mm 54.0*mm 63.5*mm 63.5*mm 2754.17*mm 4600*mm 4630*mm 5080*mm 5080*mm 5732*mm";
	$detector{"material"}    = "G4_STAINLESS-STEEL";
	$detector{"style"}       = 1;
	print_det(\%configuration, \%detector);
	...
	$detector{"type"}        = "Polycone";
	$detector{"pos"}         = "0*mm 0*mm $zpos*mm";
	$detector{"dimensions"}  = "0.0*deg 360*deg 6*counts 0.0*mm 0.0*mm 0.0*mm 0.0*mm 0.0*mm 0.0*mm 33.274*mm 33.274*mm 50.8*mm 50.8*mm 60.325*mm 60.325*mm 2754.17*mm 4600*mm 4630*mm 5080*mm 5080*mm 5732*mm";
	$detector{"material"}    = "G4_Galactic";
	$detector{"style"}       = 1;
	print_det(\%configuration, \%detector);
